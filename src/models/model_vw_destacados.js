...
const vw_destacados = database.define("vw_destacados",{
    ...
    tableName:"vw_destacados", 
    timestamps:false,
})

vw_destacados.hasMany(propiedad_has_fotos,{
    foreignKey:"idpropiedad",
    primaryKey:"idpropiedad",
    sourceKey:"idpropiedad",
});

vw_destacados.hasOne(Vendedor,{
